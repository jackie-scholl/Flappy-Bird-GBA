...
typedef unsigned int   u32, word, uint;
...
INLINE /*added by Jackie*/ void oam_init(OBJ_ATTR *obj, u32 count);
INLINE /*added by Jackie*/ void oam_copy(OBJ_ATTR *dst, const OBJ_ATTR *src, u32 count);
...
INLINE /*added by Jackie*/ void obj_copy(OBJ_ATTR *dst, const OBJ_ATTR *src, u32 count);
...
INLINE void obj_copy(OBJ_ATTR *dst, const OBJ_ATTR *src, u32 count) {
